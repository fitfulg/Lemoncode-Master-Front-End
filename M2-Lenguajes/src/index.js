...
console.log(`1.-Array Head of [${arr1}] is: [${head(arr1)}]`);
...
console.log(`1.-Array Tail of [${arr2}] is: [${tail(arr2)}]`);
...
console.log(`1.-Array Init of [${arr3}] is: [${init(arr3)}]`);
...
console.log(`1.-Array Last of [${arr4}] is: [${last(arr4)}]`);
...
console.log(`2.-Concat of [${arr5}]+[${arr6}]= [${concat(arr5, arr6)}]`);
...
console.log(`2.-Concat of [${arr5}]+[${arr6}]+[${arr7}]= [${concatMore(arr5, arr6, arr7)}]`);
...
console.log(`3.-Properties of ${JSON.stringify(source)} are: ${clone(source)}`);
...
//   merge(source, target)
console.log("3.-Merged new object is: ", merge(source, target));
